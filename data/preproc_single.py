...
sequences = pd.read_csv("raw_data/all_DRGN_seqs.csv", index_col=0)
labels = pd.read_csv("raw_data/DRGN.txt", sep="\t", header=None, names=["identifier", "location", "label"])
...
testing_df.to_csv("mixed/single/test.csv")
training_df.to_csv("mixed/single/train.csv")
